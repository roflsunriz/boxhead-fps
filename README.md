...
- グレネードは地面や障害物で反射し、爆発地点の接触面へ不規則な焦げ、低い破砕縁、散乱した瓦礫で構成するクレーターを残す。爆発跡は最新20個を保持する
...
- 味方ボットは身体と装備の縁を常時シアン色でハイライトし、ヘルメット後頭部のシアンIFFでも背面から識別できる。輪郭とIFFは照準の当たり判定には含まれない
...
bun run test         # Playwright E2E (92 項目)
